// src/pages/admin/MantenimientoDatosPage.jsx
import React from 'react';
import { Users, Package, Tag, Shield, Database, Plus, Edit, Trash2 } from 'lucide-react';
import { Link } from 'react-router-dom';

const MantenimientoDatosPage = ({ user }) => {
  const dataModules = [
    {
      id: 'clientes',
      title: 'Clientes',
      ...
      icon: Users,
      color: 'blue',
      path: '/admin/mantenimiento/clientes'
    },
    {
      id: 'recursos',
      title: 'Recursos',
      ...
      icon: Package,
      color: 'green',
      path: '/admin/mantenimiento/recursos'
    },
    {
      id: 'tipos-recursos',
      ...
      icon: Tag,
      color: 'purple',
      path: '/admin/mantenimiento/tipos-recursos'
    },
    {
      id: 'usuarios',
...
export default MantenimientoDatosPage;